...
import type { TeamDisbandmentRepairService } from '../services/team-disbandment-repair-service.js';
...
export interface CommandContext {
  ...
  >;
  teamDisbandmentRepairService?: Pick<TeamDisbandmentRepairService, 'repair'>;
