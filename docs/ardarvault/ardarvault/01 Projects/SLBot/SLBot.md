...
- `/promote`, `/demote`, `/folist`, role-derived offer source, team-inactivation removal, and general mutation audit publication remain out of scope for the public command surface.
