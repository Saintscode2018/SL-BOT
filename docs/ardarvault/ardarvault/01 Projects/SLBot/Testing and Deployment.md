...
Promotion/demotion/folist commands, release reasons, target DMs/approval, demand gameplay counts, pending-offer cancellation, role-derived offer source, imports, team-inactivation removal, and general mutation audit publication are not part of this deployment.
